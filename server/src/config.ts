...
export class Config {
  debugLogging = 'debug';
  'app.ip' = 'http://192.168.1.67'
  'app.port' = '8081'
  'email.server' = 'smtp.gmail.com'
  'email.port' = '465'
  'email.address' = 'lacus.contact@gmail.com'
  'email.password' = 'Lacus123'
  'stripeApi.secretKey' = 'sk_test_51HbYvKK02lJ8zoNWlfohkowTRhGpH8zvckTy3NIQrMYkfs2rHygfIDhcdqvbYEGWCta4m8ddSwQ3FlnJlAZE3VPy00zPEZeC8w';
  'googleAPI.key' = 'AIzaSyB8e7yEqUG_6l_CeR5f29H_UZplsApI8pQ';
  'googleApi.images.path' = './google/';
  'googleApi.error.image.path' = './google/empty.png';
  'lacus.daysToComment' = 15;
  'file.path' = './files';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'lacus';
  ...
  'jhipster.mail.from' = 'lacus@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'lacus API';
  'jhipster.swagger.description' = 'lacus API documentation';
  ...
  'eureka.instance.appname' = 'lacus';
  'eureka.instance.instanceId' = 'lacus:${random.value}';
