...
describe('Service Tests', () => {
  describe('Destination Service', () => {
    ...
    let expectedResult: IDestination | IDestination[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a Destination', () => {
        ...
        service.create(new Destination()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Destination', () => {
        const returnedFromService = Object.assign({}, elemDefault);
