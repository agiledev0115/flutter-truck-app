...
import { ReputationComponent } from 'app/entities/reputation/reputation.component';
...
describe('Component Tests', () => {
  describe('Reputation Management Component', () => {
    let comp: ReputationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReputationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reputations && comp.reputations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
