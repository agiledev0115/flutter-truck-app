...
import { TransporterAccountComponent } from 'app/entities/transporter-account/transporter-account.component';
...
describe('Component Tests', () => {
  describe('TransporterAccount Management Component', () => {
    let comp: TransporterAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TransporterAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TransporterAccount(123)],
            headers
          })
        )
      );
      ...
      expect(comp.transporterAccounts && comp.transporterAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
